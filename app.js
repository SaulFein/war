var cardsInSuite = ['two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten', 'jack', 'queen', 'king', 'ace'];
...
function createSuite(suite){
  for (var i = 0; i < 13; i++) {
    // console.log(cardsInSuite[i] + suite);
    deck.push(new Card ( suite, parseInt([i]) + 2, cardsInSuite[i] + " of " + suite ));
  }
}
